...
ce1_merge['importance_factor'] = (1+ce1_merge$Ftype) * (1+ce1_merge$Fsp) * (1+ce1_merge$Fow) * (1+ce1_merge$Flane)
ce1_merge['improve_importance_factor'] = (ce1_merge['importance_factor']-1)*ce1_merge$n
...
ce2_merge['importance_factor'] = (1+ce2_merge$Ftype) * (1+ce2_merge$Fsp) * (1+ce2_merge$Fow) * (1+ce2_merge$Flane)
ce2_merge['improve_importance_factor'] = (ce2_merge['importance_factor']-1)*ce2_merge$n
